...
$reviews = mysqli_prepare($conn, 'SELECT r.rating, r.comment, r.created_at, u.full_name FROM reviews r INNER JOIN users u ON u.user_id = r.user_id WHERE r.book_id = ? ORDER BY r.created_at DESC');
