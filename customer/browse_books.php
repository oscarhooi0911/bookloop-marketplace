...
<div class="container browse-container">
	<div class="browse-header">
		<div>
			<h2>Browse books</h2>
			<p class="browse-subtitle">Find your next pre-loved read.</p>
		</div>
		<a class="custom-btn" href="cart.php">View cart</a>
	</div>
		...
		<?php while ($book = mysqli_fetch_assoc($books)): ?>
			...
			<div class="book-card">
				...
				<div class="book-card-content">
					...
					<a class="custom-btn" href="book_detail.php?id=<?= (int) $book['book_id'] ?>">View details</a>
				</div>
			</div>
		<?php endwhile; ?>
	</div>
