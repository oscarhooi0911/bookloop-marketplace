...
// Allow access to customers and sellers
    ...
    <div class="seller-container">
        ...
        <div class="seller-page-header">
            <div>
                ...
                <p>Manage the second-hand books you have listed for sale.</p>
            </div>

            <a class="seller-btn seller-btn-primary" href="add_book.php">
                + Sell a Book
            </a>
        </div>
                ...
                <?php while ($book = mysqli_fetch_assoc($books)): ?>
                    <article class="seller-book-card">
                        <?php if (!empty($book['image'])): ?>
                            <img class="seller-book-image" src="../images/<?php echo rawurlencode($book['image']); ?>" alt="<?php echo htmlspecialchars($book['title']); ?>">
                        <?php else: ?>
                            <div class="seller-no-image">No Image</div>
                        <?php endif; ?>
                        ...
                        <div class="seller-book-content">
                            ...
                            <p>
                                <strong>Price:</strong> RM <?php echo number_format((float)$book['price'], 2); ?>
                            </p>

                            <p>
                                <strong>Quantity:</strong> <?php echo (int)$book['quantity']; ?>
                            </p>

                            <div class="seller-actions">
                                <a class="seller-btn seller-btn-edit" href="edit_book.php?id=<?php echo (int)$book['book_id']; ?>">
                                    Edit
                                </a>

                                <form class="delete-form" method="post" action="delete_book.php">
        ...
        <?php else: ?>
            <div class="seller-empty-state">
                ...
                <p>Start selling by adding your first second-hand book.</p>
                <a class="seller-btn seller-btn-primary" href="add_book.php">Add Your First Book</a>
            </div>
        <?php endif; ?>
    </div>
</section>
