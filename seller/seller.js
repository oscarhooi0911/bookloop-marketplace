    ...
    function () {
        ...
        function updateDescriptionCount() {
            if (description && descriptionCount) {
                descriptionCount.textContent = description.value.length + " / 800 characters";
            }
        }

        /*Price + quantity preview*/
        function updatePreview() {
            if (!price || !quantity || !previewText) {
                return;
            }
            ...
            if (priceValue > 0 && quantityValue > 0) {
                previewText.textContent = "RM " + priceValue.toFixed(2) + " each · " + quantityValue + " available";
            } else {
                previewText.textContent = "Enter a valid price and quantity.";
            }
        }
        ...
        if (bookForm) {
            bookForm.addEventListener(
                ...
                function (event) {
                    ...
                    if (title === "" || author === "" || genre === "" || language === "" || condition === "") {
            ...
            function (form) {
                form.addEventListener(
                    ...
                    function (event) {
                        ...
                        const button = form.querySelector(".seller-btn-delete");
